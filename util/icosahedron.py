...
class Icosahedron( object ):
    ...
    def make_faces( self ):
        self.faces = (
            ...
            Polygon( ( self.vertices[6], self.vertices[2], self.vertices[7]), precalculate=True ),
            Polygon( ( self.vertices[7], self.vertices[3], self.vertices[8]), precalculate=True ),
            Polygon( ( self.vertices[8], self.vertices[4], self.vertices[9]), precalculate=True ),
            Polygon( ( self.vertices[9], self.vertices[5], self.vertices[10]), precalculate=True ),
            Polygon( ( self.vertices[10], self.vertices[1], self.vertices[6]), precalculate=True ),
